                            ...
                            const bool aCanStoreInRuleTree)
{
  ...
  SetCoord(*aRuleData->ValueForTextIndent(), text->mTextIndent, parentText->mTextIndent,
           SETCOORD_LPH | SETCOORD_INITIAL_ZERO | SETCOORD_STORE_CALC | SETDSC_UNSET_INHERIT,
           aContext, mPresContext, canStoreInRuleTree);
  ...
  // XXX: for text-orientation and combine-horizontal
  // also add  | SETDSC_UNSET_INHERIT
  
  // TODO: add text-orientation and combine-horizontal
...
#define FOR_ALL_ANIMATION_PROPS(var_) \
  ...
  SetCoord(*aRuleData->ValueForPerspective(), 
           ...
           SETCOORD_LAH | SETCOORD_INITIAL_NONE | SETCOORD_NONE | SETCOORD_UNSET_INITIAL,
           aContext, mPresContext, canStoreInRuleTree);
